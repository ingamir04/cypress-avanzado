describe('Intercetando network requests', () => {
    ...
    it('Test Intercept forzar a que falle', () => {
        
        //Simular respuesta de un servidor que no esta disponible o casos donde queremos que falle
        cy.intercept("GET", "https://pokeapi.co/api/v2/pokemon-species/1", {forceNetworkError: true}).as(
            "error"
        )
        cy.visit('/');
    ...
    it.only('Test intercept cambiando el body', () => {
